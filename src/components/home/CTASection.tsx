      ...
      <div className="container mx-auto px-5 md:px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-vibrant rounded-2xl p-6 flex items-center justify-between text-primary-foreground relative overflow-hidden group">
            <div className="absolute -top-8 -right-8 w-24 h-24 bg-white/10 rounded-full blur-lg group-hover:scale-150 transition-transform duration-500" />
            ...
            <Link to="/products" className="relative w-10 h-10 rounded-full bg-white/15 flex items-center justify-center hover:bg-white/25 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
            </Link>
          </div>

          {/* Ticker */}
          <div className="md:col-span-2 bg-background rounded-2xl border border-border/50 p-6 flex items-center justify-between shadow-sm hover:shadow-elevated transition-shadow duration-300">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center">
                <span className="text-sm font-heading font-bold text-gradient-primary">CT</span>
              </div>
              <div>
                <span className="font-heading font-bold text-foreground">Cure Tech Pharma</span>
                <span className="text-xs text-muted-foreground ml-2">Hyderabad, India</span>
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
                <span className="text-2xl font-heading font-bold text-gradient-primary">1000+</span>
